...
class MailsControllerTest < ActionController::TestCase
  ...
  test "should create mail" do
    assert_difference('Mail.count') do
      post :create, mail: { date: @mail.date, email: @mail.email, from: @mail.from, status: @mail.status, subject: @mail.subject, text: @mail.text, to: @mail.to }
    end
  ...
  test "should update mail" do
    patch :update, id: @mail, mail: { date: @mail.date, email: @mail.email, from: @mail.from, status: @mail.status, subject: @mail.subject, text: @mail.text, to: @mail.to }
    assert_redirected_to mail_path(assigns(:mail))
  end
